      ...
      <div>
        ...
        <div className="mb-4">
          ...
          {formik.touched.city && formik.errors.city && (
            <div className="text-red-500 mt-1 text-sm">{formik.errors.city}</div>
          )}
        </div>
...
export const VendorRegistrationForm: React.FC = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async ({ name, email, password, phone, city, type_Of_Business, businessName }) => {
      const data = {name, email, password, phone, city, type_Of_Business, businessName};
      await register(data);
    },
    })
      ...
      <div>
        ...
        <div className="mb-4">
          ...
          {touched.businessName && errors.businessName && (
            <div className="text-red-500 mt-1 text-sm">{errors.businessName}</div>
          )}
        </div>
        ...
        <div className="mb-4">
          ...
          {touched.type_Of_Business && errors.type_Of_Business && (
            <div className="text-red-500 mt-1 text-sm">{errors.type_Of_Business}</div>
          )}
        </div> 
