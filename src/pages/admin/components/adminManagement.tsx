...
const AdminManagement: React.FC = () => {
  ...
  const deleteSelected = () => {
    // Filter out the selected admins
    const selectedAdminsIndexes = checkboxStates.reduce((indexes: number[], checked, index) => {
    ...
    // Remove the selected admins from the list
    const updatedAdmins = admins.filter((admin, index) => !selectedAdminsIndexes.includes(index));
  
    // Update the state to reflect the new list of admins
    console.log("selected admins deleted", selectedAdminsIndexes);
